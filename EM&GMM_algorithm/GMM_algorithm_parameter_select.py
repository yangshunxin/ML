...
## 数据分割
x, x_test, y, y_test = train_test_split(data_x, data_y, test_size=0.4, random_state=0)

## 模型创建及训练   n_components  表示每个特征维度上有几个 高斯分布--即目标的类别个数
